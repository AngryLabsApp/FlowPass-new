<script lang="ts">
  ...
  import { loginWithEmail, sendResetPasswordEmail } from '$lib/services/supabase/auth';
  ...
  <Card class="w-full max-w-md p-4 sm:p-6 md:p-8">
    <form class="flex flex-col space-y-6" on:submit={onSubmit} novalidate>
      <h3 class="text-xl font-medium text-gray-900 dark:text-white">Acceso al panel</h3>
      ...
      <div class="flex items-start">
        <button type="button" class="ms-auto text-sm text-primary-700 dark:text-primary-500 hover:underline"
                on:click={onForgot}>
